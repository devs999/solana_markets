  Solana Prediction Market Smart Contract body { font-family: 'Arial', sans-serif; line-height: 1.6; margin: 2rem; } code { background-color: #f4f4f4; padding: 0.2rem 0.5rem; border-radius: 4px; }
